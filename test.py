...
if __name__ == "__main__":
  event = {"game_list": ("Minecraft", "Need for Speed™ Hot Pursuit Remastered", "Overcooked! 2","Super Smash Bros.™ Ultimate","Hollow Knight", "Fitness Boxing 2: Rhythm & Exercise", "Mario Kart™ 8 Deluxe", "Super Mario Maker™ 2","Luigi’s Mansion™ 3", "Bayonetta™ 2", "Bayonetta™")}
